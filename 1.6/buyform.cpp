...
buyform::buyform(QWidget *parent) : QDialog(parent)
{
    ...
    connect(pushbutton, &QPushButton::clicked, this, &buyform::buyform1);

    pushbutton1 = new QPushButton(this);
    pushbutton1->move(250, 250);
    pushbutton1->setText("返回");
    connect(pushbutton1, &QPushButton::clicked, this, &buyform::shut);
